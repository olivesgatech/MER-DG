                    ...
                    if split == 'test':
                        ...
                        if currenttestAcc >= BestTestAcc:
                            ...
                            if args.save_best:
                                ...
                                torch.save(save, os.path.join(base_path_model, log_name + '_best_%s.pt'%(str(epoch_i))))
                        ...
                        if args.save_checkpoint:
                            ...
                            torch.save(save, os.path.join(base_path_model, log_name + '.pt'))
